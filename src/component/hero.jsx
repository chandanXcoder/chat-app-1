  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute top-40 right-32 w-48 h-48 bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute bottom-32 left-1/3 w-40 h-40 bg-cyan-500/10 rounded-full blur-2xl animate-pulse delay-2000" />
        <div className="absolute bottom-20 right-20 w-36 h-36 bg-pink-500/10 rounded-full blur-2xl animate-pulse delay-500" />
      </div>

      {/* Floating Code Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <span className="absolute top-1/4 left-1/4 text-blue-400/20 text-sm font-mono animate-float">
          {"<div>"}
        </span>
        <span className="absolute top-1/3 right-1/4 text-purple-400/20 text-sm font-mono animate-float delay-1000">
          {"console.log()"}
        </span>
        <span className="absolute bottom-1/3 left-1/3 text-cyan-400/20 text-sm font-mono animate-float delay-2000">
          {"function()"}
        </span>
        <span className="absolute bottom-1/4 right-1/3 text-pink-400/20 text-sm font-mono animate-float delay-500">
          {"</>"}
        </span>
      </div>

      {/* Main Content */}
      <div className="relative z-10 flex flex-col justify-center items-center w-full h-full px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center w-full max-w-6xl mx-auto">
          {/* Welcome Badge */}
          <div
            className={`inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-blue-500/20 text-blue-300 text-sm font-medium mb-8 transition-all duration-1000 ${
            ...
            <div className="h-16 sm:h-20 flex items-center justify-center">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-gray-300">
                ...
                <span className="text-blue-400 font-bold relative">
                  {displayText}
                  <span
                    className={`inline-block w-1 h-8 sm:h-10 bg-blue-400 ml-1 ${
          ...
          {/* Description */}
          <p
            className={`text-lg sm:text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-400 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            Passionate developer crafting exceptional digital experiences with
            clean code, innovative solutions, and user-focused design. Let's
            build something amazing together.
          </p>

          {/* Location */}
          <div
            className={`flex items-center justify-center text-gray-500 mb-12 transition-all duration-1000 delay-500 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          {/* Skills */}
          <div
            className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-16 transition-all duration-1000 delay-800 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          {/* Stats */}
          <div
            className={`grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto transition-all duration-1000 delay-900 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
